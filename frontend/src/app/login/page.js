        ...
        {!forgotOpen ? (
          <form onSubmit={handleSubmit} className="relative space-y-5">
            ...
            <div className="animate-rise delay-4">
              ...
              <div className="relative group">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-3 text-gray-500 hover:text-gray-300 active:scale-90 transition-all"
            ...
            <div className="flex items-center justify-between text-sm animate-rise delay-5">
              ...
              <button type="button" onClick={() => setForgotOpen(true)} className="text-accent-400 hover:text-accent-300 active:text-accent-200 transition-colors hover:underline underline-offset-4">
                Forgot password?
              </button>
            </div>
